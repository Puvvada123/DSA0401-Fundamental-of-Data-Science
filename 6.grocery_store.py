...
total_before_discount = sum(p * q for p, q in zip(item_prices, item_quantities)) 
discount_amount = (discount_rate / 100) * total_before_discount
total_cost_after_discount = total_before_discount - discount_amount
tax_amount = (tax_rate / 100) * total_cost_after_discount
final_total_cost = total_cost_after_discount + tax_amount

print("Total cost before discount and tax:", total_before_discount)
